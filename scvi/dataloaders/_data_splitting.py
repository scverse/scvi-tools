...
class DataSplitter(pl.LightningDataModule):
    ...
    pin_memory
        Whether to copy tensors into device/cuda pinned memory, passed into
        :class:`~scvi.dataloaders.AnnDataLoader`. If `None`, defaults to the
        value of `scvi.settings.dl_pin_memory_gpu_training`.
    **kwargs
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if pin_memory is None:
            self.pin_memory = settings.dl_pin_memory_gpu_training
        else:
