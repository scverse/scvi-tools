...
def pairs_sampler(
    arr1: list[bool] | np.ndarray | torch.Tensor,
    arr2: list[bool] | np.ndarray | torch.Tensor,
    use_permutation: bool = True,
    m_permutation: int = None,
    sanity_check_perm: bool = False,
    weights1: list[bool] | np.ndarray | torch.Tensor = None,
    weights2: list[bool] | np.ndarray | torch.Tensor = None,
) -> tuple:
    """Creates more pairs.
