...
from ._built_in_data._cite_seq import (_load_pbmc_seurat_v4_cite_seq,
                                       _load_pbmcs_10x_cite_seq,
                                       _load_spleen_lymph_cite_seq)
from ._built_in_data._cortex import _load_cortex
from ._built_in_data._csv import (_load_breast_cancer_dataset,
...
from ._built_in_data._loom import (_load_annotation_simulation,
                                   _load_frontalcortex_dropseq,
                                   _load_prefrontalcortex_starmap,
                                   _load_retina)
from ._built_in_data._pbmc import (_load_pbmc_dataset,
