...
class DecoderTOTALVI(nn.Module):
    ...
    def __init__(
        ...
        # mean gamma
        self.px_scale_decoder = nn.Linear(n_hidden + n_input, n_output_genes)
    ...
    def forward(self, z: torch.Tensor, library_gene: torch.Tensor, *cat_list: int):
        ...
        px_["scale"] = nn.Softmax(dim=-1)(self.px_scale_decoder(px_cat_z))
        ...
        py_["fore_scale"] = self.py_fore_scale_decoder(py_fore_cat_z) + 1 + 1e-8
