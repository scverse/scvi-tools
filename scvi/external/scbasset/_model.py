    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self._model_summary_string = ("ScBasset Model with params: \nn_regions: {}, n_batch: {}, n_cells: {}").format(
            self.n_regions,
            self.n_batch,
            self.n_cells,
        )
    ...
    def get_tf_activity(
        ...
        model_input_size = self.adata_manager.get_from_registry(REGISTRY_KEYS.DNA_CODE_KEY).shape[1]
