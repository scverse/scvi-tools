...
class ContrastiveVI(BaseModelClass):
    ...
    def __init__(
        ...
        self._model_summary_string = (
            ...
            f"n_background_latent: {n_background_latent}, n_salient_latent: {n_salient_latent}, n_layers: {n_layers}, "
            f"dropout_rate: {dropout_rate}, use_observed_lib_size: {use_observed_lib_size}, wasserstein_penalty: {wasserstein_penalty}"
        )
