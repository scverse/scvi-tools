...
class LoomDataset(GeneExpressionDataset):
    ...
    def __init__(self, filename, save_path, gene_row=False, cluster_col=False, batch_col=False, url=False):
        ...
        if cluster_col is not False and batch_col is not False:  # File has cluster and batch info
        ...
        elif gene_names is not False:  # File has gene names info
