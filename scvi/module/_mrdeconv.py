...
from scvi.compose import BaseModuleClass, FCLayers, LossRecorder, auto_move_data
...
class MRDeconv(BaseModuleClass):
    ...
    sc_state_dict
        Tuple of dictionnaries containing the parameters for the decoder of CondSCVI and the dispersion parameter
    n_hidden
