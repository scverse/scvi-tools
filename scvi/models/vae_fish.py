...
class VAEF(VAE):
    ...
    def sample_from_posterior_z(self, x, y=None, mode="scRNA"):
        ...
        :return: tensor of means with shape ``(batch_size, n_latent)``
    ...
    def get_sample_rate(self, x, y=None, mode="scRNA"):
        ...
        :param y: tensor of cell-types labels with shape ``(batch_size,)``
        :param mode: string that indicates the type of data we analyse
        :return: tensor of means of the negative binomial distribution
        :rtype: :py:class:`torch.Tensor`
        """
        if mode == "scRNA":
    ...
    def classify(self, x, mode="scRNA"):
        ...
        :param x: tensor of values with shape (batch_size, n_input or n_input_fish depending on the mode)
        :param mode: string that indicates the type of data we analyse
        :return: tensor with shape``(batch_size,)`` of probabilities of corresponding to the different labels
        :rtype: :py:class:`torch.Tensor`
        """
