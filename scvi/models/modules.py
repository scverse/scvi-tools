...
class FCLayers(Module):
    ...
    def __init__(self, n_in: int, n_out: int, n_cat_list: Iterable[int] = None,
        ...
        print("Using layers as they are")
        ...
        self.fc_layers = nn.Sequential(collections.OrderedDict(
            [('Layer {}'.format(i), nn.Sequential(
                ...
                Linear(n_in + sum(self.n_cat_list), n_out),
                nn.BatchNorm1d(n_out, momentum=.01, eps=0.001),#,momentum=0.99), track_running_stats=False eps=0.001
...
class Encoder(Module):
    ...
    def reparameterize(self, mu, var):
        return Normal(mu, var.sqrt()).rsample() # sample instead of rsample
...
class Decoder(Module):
    ...
    def __init__(self, n_input: int, n_output: int,
        ...
        self.mean_decoder = Linear(n_hidden, n_output)
        self.var_decoder = Linear(n_hidden, n_output)
