...
- Add [scvi-tools MCP](%22https://scvi-tools-mcp.readthedocs.io/en/latest/index.html%22) package that gives any MCP-compatible LLM access to scvi-tools knowledge
