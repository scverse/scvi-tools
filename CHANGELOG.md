...
- Remove {class}`scvi.external.DestVI`, {class}`scvi.external.GimVI`, {class}`scvi.external.ResolVI`,
    {class}`scvi.external.SCVIVA`, {class}`scvi.external.Stereoscope`, and {class}`scvi.external.Tangram`
    spatial models, along with their associated tutorials and documentation, {pr}`3908`.
