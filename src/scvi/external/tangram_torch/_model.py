...
from scvi.external.tangram_torch._module import TANGRAM_REGISTRY_KEYS, TangramMapperTorch
...
class TangramTorch(BaseModelClass):
    ...
    ----------
    mdata
        MuData object that has been registered via
        :meth:`~scvi.external.TangramTorch.setup_mudata`.
    constrained
    ...
    **model_kwargs
        Keyword args for :class:`~scvi.external.tangram_torch.TangramMapperTorch`
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        self.module = TangramMapperTorch(
    ...
    def _get_tensor_dict(
        ...
        for key in TANGRAM_REGISTRY_KEYS:
            ...
            tensor_dict[key] = torch.as_tensor(tensor_dict[key], device=device)
