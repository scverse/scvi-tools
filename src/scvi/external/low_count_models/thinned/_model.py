"""Thinned SCVI model for ablation study."""
...
from ._module import ThinnedVAE
...
class ThinnedSCVI(SCVI):
    """SCVI trained on randomly thinned data.

    This model extends the standard SCVI by training on thinned versions of the
    ...
    **kwargs
    ...
    >>> scvi.external.ThinnedSCVI.setup_anndata(adata, batch_key="batch")
    >>> model = scvi.external.ThinnedSCVI(adata, min_library_size=10.0)
    >>> model.train()
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._model_summary_string = (
            "ThinnedSCVI model with the following parameters: \n"
