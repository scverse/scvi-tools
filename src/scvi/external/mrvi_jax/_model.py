...
class JaxMRVI(JaxTrainingMixin, BaseModelClass):
    ...
    ----------
    adata
        AnnData object that has been registered via :meth:`~scvi.external.JaxMRVI.setup_anndata`.
    n_latent
    ...
    px_kwargs
        Keyword args for :class:`~scvi.external.mrvi_jax._module.DecoderZXAttention`.
    qz_kwargs
        Keyword args for :class:`~scvi.external.mrvi_jax._module.EncoderUZ`.
    qu_kwargs
        Keyword args for :class:`~scvi.external.mrvi_jax._module.EncoderXU`.

    Notes
    -----
    This implementation of MRVI in JAX is deprecated and will be unsupported in v1.5.
    ...
    See Also
    --------
    :class:`~scvi.external.mrvi_jax.JaxMRVAE`
    """
    ...
    def __init__(self, adata: AnnData, **model_kwargs):
        ...
        warnings.warn(
            "You are using the Jax Version of MrVI, which is the deafult. Starting v1.5, "
            "This class will still be usable won't be as actively maintained as the PyTorch "
            "implementation of MRVI",
            DeprecationWarning,
