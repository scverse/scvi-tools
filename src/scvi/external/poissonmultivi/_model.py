    ...
    * The accessibility counts should be fragment counts and not read counts or binarized data.
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        use_size_factor_key_expr = (
            REGISTRY_KEYS.SIZE_FACTOR_KEY_EXPR in self.adata_manager.data_registry
        )
        use_size_factor_key_acc = (
            REGISTRY_KEYS.SIZE_FACTOR_KEY_ACC in self.adata_manager.data_registry
        )
        ...
        self.module = self._module_cls(
            ...
            use_size_factor_key_expr=use_size_factor_key_expr,
            use_size_factor_key_acc=use_size_factor_key_acc,
    ...
    def get_accessibility_estimates(
        ...
        for tensors in scdl:
            ...
            for batch in transform_batch:
                ...
                output = generative_outputs["px_scale_acc"]
        ...
        if return_numpy:
            ...
            return pd.DataFrame(
                accs,
                columns=adata.var_names[self.n_genes : (self.n_genes + self.n_regions)][
                    region_mask
                ],
    ...
    def setup_anndata(
        ...
        size_factor_key_expr: str | None = None,
        size_factor_key_acc: str | None = None,
        ...
        **kwargs,
        ...
        anndata_fields = [
            # TODO: check fragment count might not work here because it's both RNA and ATAC
            LayerField(
                REGISTRY_KEYS.X_KEY,
                layer,
                is_count_data=True,
                check_fragment_counts=True,
            ),
            batch_field,
            CategoricalObsField(REGISTRY_KEYS.LABELS_KEY, None),
            CategoricalObsField(REGISTRY_KEYS.BATCH_KEY, batch_key),
            NumericalObsField(
                REGISTRY_KEYS.SIZE_FACTOR_KEY_EXPR, size_factor_key_expr, required=False
            ),
            NumericalObsField(
