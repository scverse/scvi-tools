...
from scvi.external.tangram_jax._module import TANGRAM_REGISTRY_KEYS, TangramMapperJax
...
class TangramJax(BaseModelClass):
    """JAX reimplementation of Tangram :cite:p:`Biancalani21`.
    ...
    ----------
    mdata
        MuData object that has been registered via :meth:`~scvi.external.TangramJax.setup_mudata`.
    constrained
    ...
    **model_kwargs
        Keyword args for :class:`~scvi.external.tangram_jax.TangramMapperJax`
    ...
    def train(
        ...
        %(param_devices)s
        lr
            Optimiser learning rate (default optimiser is :class:`~optax.adam`).
