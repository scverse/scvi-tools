...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", type=int, default=1, help="how many times to process the dataset")
    ...
    run_benchmarks_classification(gene_dataset, n_epochs=args.epochs, n_epochs_classifier=args.epochs,
