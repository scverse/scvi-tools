...
2. Install [PyTorch] and [jax]. If you have an Nvidia GPU, be sure to install a versions of PyTorch and jax that support it -- scvi-tools runs much faster with a discrete GPU.
