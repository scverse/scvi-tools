...
- metrics: Either a single metric or a list of metrics to track during the experiment and select the best hyperparameters based on.
We typically use a metric that is one of the common metrics we calculate at each step, like "elbo_validation".
