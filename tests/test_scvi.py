...
def test_synthetic_1():
    ...
    infer_synthetic = JointSemiSupervisedVariationalInference(svaec, synthetic_dataset, use_cuda=use_cuda)
    infer_synthetic.fit(n_epochs=1)
    infer_synthetic.be('labelled')
