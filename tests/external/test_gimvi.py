        ...
        **anndata_write_kwargs,
        ...
        if save_anndata:
            ...
            for i in range(len(model.adatas)):
                ...
                varnames_save_path = os.path.join(dir_path, f"{file_name_prefix}var_names_{dataset_name}.csv")
...
def test_gimvi():
    ...
    assert hasattr(model.module, "library_log_means_0") and not hasattr(model.module, "library_log_means_1")
